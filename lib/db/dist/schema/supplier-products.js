import { pgTable, serial, text, timestamp, integer, numeric, index, unique, boolean, jsonb, } from "drizzle-orm/pg-core";
...
// ---------------------------------------------------------------------------
export const supplierLedgerEntriesTable = pgTable("supplier_ledger_entries", {
    id: serial("id").primaryKey(),
    supplierId: integer("supplier_id").notNull().references(() => suppliersTable.id),
...
//# sourceMappingURL=supplier-products.js.map