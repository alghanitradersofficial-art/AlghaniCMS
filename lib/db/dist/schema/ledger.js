import { pgTable, serial, text, timestamp, integer, numeric, jsonb, index, boolean, } from "drizzle-orm/pg-core";
...
export const priceHistoryTable = pgTable("customer_price_history", {
...
export const ledgerEntriesTable = pgTable("customer_ledger_entries", {
    id: serial("id").primaryKey(),
    customerId: integer("customer_id").notNull().references(() => customersTable.id),
