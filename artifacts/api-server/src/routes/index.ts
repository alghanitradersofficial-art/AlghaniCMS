...
import supplierPriceHistoryRouter from "./supplier-price-history.js";
import productSuppliersRouter from "./product-suppliers.js";
import calendarRouter from "./calendar.js";
import cashEntriesRouter from "./cash-entries.js";
...
router.use("/suppliers", requirePermission("suppliers"), supplierPriceHistoryRouter);
...
router.use("/cash-entries", requirePermission("settings"), cashEntriesRouter);
